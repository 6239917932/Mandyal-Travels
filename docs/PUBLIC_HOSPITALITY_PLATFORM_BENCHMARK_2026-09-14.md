...
| Packages, upgrades and add-ons             | AxisRooms, Zotel and Hotel-Spider advertise packages, upsells or custom experiences                       | Partial                                                  | Promotions and during-stay services exist; add a governed pre-booking add-on catalogue and immutable price snapshots                                                                |
...
2. Booking add-ons and packages: property catalogue, availability window, tax treatment, immutable
   quote snapshot, payment allocation, cancellation/refund handling and folio posting.
