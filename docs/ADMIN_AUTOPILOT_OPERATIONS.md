...
maintenance run evidence. It provides closed status and time-window filters, capped pagination,
...
provider errors, or customer data. It cannot manually trigger a run or mutate payments, refunds,
