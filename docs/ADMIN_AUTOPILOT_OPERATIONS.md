...
maintenance, notification-delivery, and search-projection run evidence. It provides closed status and
time-window filters, capped pagination, private correlation references, lease health, processed totals,
and allow-listed numeric summaries.
