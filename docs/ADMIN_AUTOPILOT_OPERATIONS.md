...
maintenance, notification-delivery, integration-outbox delivery, search-projection, and successful isolated database-restore
...
infrastructure, secret-managed worker identities, alerts, and an accountable run owner.
