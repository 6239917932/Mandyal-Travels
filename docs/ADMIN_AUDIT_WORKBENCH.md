...
The workbench displays only the actor identity and operational context needed for investigation. It
does not expose passwords, session tokens, reset tokens, payment credentials, provider payloads, or
free-form audit metadata. It offers no create, update, delete, booking, inventory, payment, refund,
or reconciliation action. Cashfree is not read, configured, or modified by this module.
