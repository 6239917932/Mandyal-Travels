...
| Purchase orders, approval, partial GRN and supplier performance              | PO creation, recorded approval and partial receipt matching are live | Retain the governed workflow; supplier scoring and payment release remain separate until evidence and finance controls are approved                                               |
