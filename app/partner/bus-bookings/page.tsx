...
export default function PartnerBusBookingsPage() {
  ...
  return <section className="account-page partner-bookings"><div className="partner-page__heading"><div><p className="hotel-page__eyebrow">Bus operator reservations</p><h1>Passenger and seat manifest</h1><p>Review confirmed direct-channel passengers, seats, routes, services, and captured value.</p></div><div className="manage-booking__document-actions"><a className="ui-button ui-button--secondary" href="/api/v1/partner/bus-reservations/export">Export CSV</a><Link className="ui-button ui-button--secondary" href="/partner/bus-operations">Route operations</Link></div></div>
