...
export default async function PartnerBusOperationsPage() {
  ...
  return <section className="account-page"><div className="partner-page__heading"><div><p className="hotel-page__eyebrow">Bus operator operations</p><h1>Routes, schedules, seats, and fares</h1><p>Create governed route definitions and dated services before distributing them to customer search.</p></div><Link className="ui-button ui-button--secondary" href="/partner">Supplier workspace</Link></div><PartnerBusOperations canCreateRoutes={access.memberRole === 'ADMIN'} /></section>;
}
