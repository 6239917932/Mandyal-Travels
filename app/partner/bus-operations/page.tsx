  ...
  return (
    <section className="account-page">
      <div className="partner-page__heading">
        <div>
          <p className="hotel-page__eyebrow">Bus operator operations</p>
          <h1>Routes, schedules, seats, and fares</h1>
          <p>
            Create governed route definitions and dated services before distributing them to
            customer search.
          </p>
        </div>
        <div className="manage-booking__document-actions">
          <Link className="ui-button ui-button--secondary" href="/partner/bus-bookings">
            Passenger manifest
          </Link>
          <Link className="ui-button ui-button--secondary" href="/partner/reports">
            Performance reports
          </Link>
          <Link className="ui-button ui-button--secondary" href="/buses">
            Live bus search
          </Link>
        </div>
      </div>
