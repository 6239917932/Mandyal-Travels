...
export async function PATCH(
  ...
  const action = String(body?.action ?? '') as
    'PAUSE' | 'PUBLISH' | 'SUBMIT_REVIEW' | 'UPDATE_CONTENT' | 'UPDATE_LOCATION' | 'UPDATE_PROFILE';
  if (
    ![
      'PAUSE',
      'PUBLISH',
        ...
        : action === 'UPDATE_PROFILE'
          ...
          : action === 'UPDATE_CONTENT'
            ...
            : action === 'SUBMIT_REVIEW'
              ...
              : await partnerOperationsService.setPropertyPublication(
                  access.partnerId,
                  propertyId,
                  action,
                );
      ...
      action:
        action === 'PUBLISH'
          ...
          : action === 'PAUSE'
            ? 'PROPERTY_PAUSED'
            : action === 'SUBMIT_REVIEW'
              ? 'PROPERTY_REVIEW_SUBMITTED'
              : action === 'UPDATE_PROFILE'
                ? 'PROPERTY_PROFILE_UPDATED'
                : action === 'UPDATE_CONTENT'
                  ? 'PROPERTY_CONTENT_UPDATED'
