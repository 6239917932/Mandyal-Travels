...
- Automated clean-database migration and foreign-key integrity verification in the release quality
  gate
- Deterministic PostgreSQL schema materialization with a reviewable 98-table native baseline, Prisma
...
integrity enabled, a synchronized 98-table PostgreSQL-native baseline, and the portable deployment
