...
- Automated clean-database migration and foreign-key integrity verification in the release quality
  gate
- Deterministic PostgreSQL schema materialization with a reviewable 96-table native baseline, Prisma
...
integrity enabled, a synchronized 96-table PostgreSQL-native baseline, and the portable deployment
