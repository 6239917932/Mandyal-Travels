CREATE TABLE "HotelGuestRegistration" (
    ...
    CONSTRAINT "HotelGuestRegistration_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "HotelGuestRegistration" ADD CONSTRAINT "HotelGuestRegistration_bookingId_fkey" FOREIGN KEY ("bookingId") REFERENCES "Booking"("id") ON DELETE CASCADE ON UPDATE CASCADE;
