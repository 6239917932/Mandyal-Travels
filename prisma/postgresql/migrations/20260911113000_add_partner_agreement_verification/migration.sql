...
ALTER TABLE "PartnerApplication" ADD COLUMN "agreementAcceptedAt" TIMESTAMP(3);
ALTER TABLE "PartnerApplication" ADD COLUMN "agreementEmailStatus" TEXT NOT NULL DEFAULT 'PENDING';
ALTER TABLE "PartnerApplication" ADD COLUMN "agreementEmailSentAt" TIMESTAMP(3);
...
ALTER TABLE "PartnerApplication" ADD COLUMN "signedAgreementReceivedAt" TIMESTAMP(3);
