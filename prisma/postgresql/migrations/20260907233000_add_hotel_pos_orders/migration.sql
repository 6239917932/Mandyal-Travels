CREATE TABLE "HotelPosOrder" (
    ...
    CONSTRAINT "HotelPosOrder_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "HotelPosOrderEvent" (
    ...
    "requestFingerprint" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "HotelPosOrderEvent_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "HotelPosOrder" ADD CONSTRAINT "HotelPosOrder_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "SupplyPartner"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelPosOrder" ADD CONSTRAINT "HotelPosOrder_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "PartnerProperty"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelPosOrder" ADD CONSTRAINT "HotelPosOrder_bookingId_fkey" FOREIGN KEY ("bookingId") REFERENCES "Booking"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelPosOrder" ADD CONSTRAINT "HotelPosOrder_folioEntryId_fkey" FOREIGN KEY ("folioEntryId") REFERENCES "HotelFolioEntry"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelPosOrderEvent" ADD CONSTRAINT "HotelPosOrderEvent_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "HotelPosOrder"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
