CREATE TABLE "HotelLostFoundItem" (
  ...
  CONSTRAINT "HotelLostFoundItem_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "HotelLostFoundEvent" (
  ...
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "HotelLostFoundEvent_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "HotelLostFoundItem" ADD CONSTRAINT "HotelLostFoundItem_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "SupplyPartner"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelLostFoundItem" ADD CONSTRAINT "HotelLostFoundItem_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "PartnerProperty"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelLostFoundEvent" ADD CONSTRAINT "HotelLostFoundEvent_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "HotelLostFoundItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelLostFoundEvent" ADD CONSTRAINT "HotelLostFoundEvent_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "SupplyPartner"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelLostFoundEvent" ADD CONSTRAINT "HotelLostFoundEvent_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "PartnerProperty"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
