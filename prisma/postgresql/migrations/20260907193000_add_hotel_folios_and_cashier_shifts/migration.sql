CREATE TABLE "HotelCashierShift" (
    ...
    CONSTRAINT "HotelCashierShift_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "HotelCashierShift" ADD CONSTRAINT "HotelCashierShift_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "SupplyPartner"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelCashierShift" ADD CONSTRAINT "HotelCashierShift_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "PartnerProperty"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelFolioEntry" ADD CONSTRAINT "HotelFolioEntry_bookingId_fkey" FOREIGN KEY ("bookingId") REFERENCES "Booking"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelFolioEntry" ADD CONSTRAINT "HotelFolioEntry_cashierShiftId_fkey" FOREIGN KEY ("cashierShiftId") REFERENCES "HotelCashierShift"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "HotelFolioEntry" ADD CONSTRAINT "HotelFolioEntry_reversalOfId_fkey" FOREIGN KEY ("reversalOfId") REFERENCES "HotelFolioEntry"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
