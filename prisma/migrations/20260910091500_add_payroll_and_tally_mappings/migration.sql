CREATE TABLE "HotelPayrollRecord" (
  ...
  "reversedAt" DATETIME,
  CONSTRAINT "HotelPayrollRecord_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "SupplyPartner" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "HotelPayrollRecord_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "PartnerProperty" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "HotelPayrollRecord_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "SupplyPartnerMember" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "PartnerAccountingMapping" (
  ...
  CONSTRAINT "PartnerAccountingMapping_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "SupplyPartner" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "PartnerAccountingMapping_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "PartnerProperty" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
