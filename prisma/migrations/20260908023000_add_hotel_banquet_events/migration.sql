CREATE TABLE "HotelBanquetEvent" (
    ...
    CONSTRAINT "HotelBanquetEvent_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "SupplyPartner" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "HotelBanquetEvent_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "PartnerProperty" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "HotelBanquetEventHistory" (
    ...
    "requestFingerprint" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "HotelBanquetEventHistory_banquetEventId_fkey" FOREIGN KEY ("banquetEventId") REFERENCES "HotelBanquetEvent" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
