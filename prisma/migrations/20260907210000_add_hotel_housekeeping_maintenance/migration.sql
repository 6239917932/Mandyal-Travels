CREATE TABLE "HotelHousekeepingInspection" (
    ...
    CONSTRAINT "HotelHousekeepingInspection_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "SupplyPartner" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "HotelHousekeepingInspection_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "PartnerProperty" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "HotelHousekeepingInspection_physicalRoomId_fkey" FOREIGN KEY ("physicalRoomId") REFERENCES "PartnerPhysicalRoom" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "HotelMaintenanceWorkOrder" (
    ...
    "requestFingerprint" TEXT NOT NULL,
    CONSTRAINT "HotelMaintenanceWorkOrder_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "SupplyPartner" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "HotelMaintenanceWorkOrder_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "PartnerProperty" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "HotelMaintenanceWorkOrder_physicalRoomId_fkey" FOREIGN KEY ("physicalRoomId") REFERENCES "PartnerPhysicalRoom" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "HotelMaintenanceWorkOrderEvent" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "HotelMaintenanceWorkOrderEvent_workOrderId_fkey" FOREIGN KEY ("workOrderId") REFERENCES "HotelMaintenanceWorkOrder" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
