export const BUSINESS_AUDIT_ACTIONS = {
  AGENCY_CUSTOMER_CREATED: 'AGENCY_CUSTOMER_CREATED',
  AGENCY_CUSTOMER_UPDATED: 'AGENCY_CUSTOMER_UPDATED',
  AGENCY_CUSTOMER_STATUS_UPDATED: 'AGENCY_CUSTOMER_STATUS_UPDATED',
